...
<p>Finalizado todo este proceso y entusiasmados por los logros obtenidos en tan corto plazo. En el año 2018 se decidió rebautizar la institución y darle un nombre que identifique el nuevo proyecto. Así nace el <strong class="institucional-content-item"><a href="<?= base_url(); ?>instalacion" target="_blank" class="external-link-to-google-map" aria-label="Ir a Instalaciones">SANATORIO PRIVADO MADERO.</a></strong></p>
