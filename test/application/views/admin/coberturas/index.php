              ...
              <!-- Brand and toggle get grouped for better mobile display -->
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li><a href="<?= base_url(); ?>admin/cobertura/crearCobertura">Crear cobertura</a></li>
                        <li class="dropdown">
      ...
      <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="<?= base_url(); ?>admin/cobertura/editarFormularioCoberturas?id=<?= $cobertura->id ?>">Editar</a></td>
                <td><a href="<?= base_url(); ?>admin/cobertura/EliminarCobertura?id=<?= $cobertura->id ?>">Eliminar</a></td>
            </tr>
            <? endforeach; ?>
        </tbody>
      </table>
