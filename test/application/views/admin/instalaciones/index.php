              ...
              <!-- Brand and toggle get grouped for better mobile display -->
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li><a href="<?= base_url(); ?>admin/instalacion/crearInstalacion">Crear intalación</a></li>
                        <li class="dropdown">
      ...
      <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="<?= base_url(); ?>admin/instalacion/editarFormularioInstalaciones?id=<?= $instalacion->Id ?>">Editar</a></td>
                <td><a href="<?= base_url(); ?>admin/instalacion/EliminarInstalacion?id=<?= $instalacion->Id ?>">Eliminar</a></td>
            </tr>
            <? endforeach; ?>
        </tbody>
      </table>
